          ...
          {TimelineItems.map((item, index) => (
            ...
            >
              ...
              <motion.div
                ...
                lassName="mb-2 overflow-hidden rounded-md border-l-2 border-blue-500 bg-blue-100 p-4 pl-10  text-sm font-semibold text-gray-500 transition-all data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down sm:text-base"
              >
